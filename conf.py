...
BLOG_AUTHOR = "Shane M. Wilkins"  # (translatable)
BLOG_TITLE = "Shane's Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://shanewilkins.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://shanewilkins.github.io/"
BLOG_EMAIL = "shane.wilkins@gmail.com"
# (translatable)
BLOG_DESCRIPTION = "I'll be blogging about data science, finance, and maybe a little philosophy!"
...
# before </head>
# (translatable)
EXTRA_HEAD_DATA = "<script src='https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js'></script><script>requirejs.config({paths: { 'plotly': ['https://cdn.plot.ly/plotly-latest.min']},});if(!window.Plotly) {{require(['plotly'],function(plotly) {window.Plotly=plotly;});}}</script>"
